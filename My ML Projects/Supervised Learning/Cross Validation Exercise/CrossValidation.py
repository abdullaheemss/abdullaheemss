...
lrc_test_average = np.average(cv_results_lrc['test_score'])
...
lrc_train_average = np.average(cv_results_lrc['train_score'])

# print the results 
print()
print()
print('        ','Decision Tree  ', 'Random Forest  ', 'Logistic Regression  ','Support Vector   ')
print('        ','---------------', '---------------','-----------------','-----------------')
